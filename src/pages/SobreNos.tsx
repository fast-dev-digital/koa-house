        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 pt-24 pb-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Mais do que uma quadra, somos uma comunidade apaixonada pelo
              futevôlei
            </p>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Promover o bem-estar, o esporte e a conexão entre pessoas.
                  Queremos que cada atleta, iniciante ou profissional, se sinta
                  em casa.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Na Koa House, o sol brilha forte, mas nossa energia vai além.
                  Acreditamos no poder do esporte para transformar dias, hábitos
                  e vidas.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Aqui é mais do que uma quadra. É mais do que um espaço
                esportivo. Aqui é a Koa House — o point onde o futevôlei
                encontra a vibe da comunidade.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
                Montamos um ambiente onde você pode jogar, relaxar, socializar
                e, claro, tomar aquela gelada com os amigos.
              </p>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Valorizamos quem faz parte da nossa história: alunos,
                professores, parceiros e amigos.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Comprometidos com a excelência, desde o atendimento até cada
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Uma família apaixonada pelo futevôlei, onde cada treino vira uma
                lembrança especial.
              </p>
            </div>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
              Conheça os espaços onde a magia acontece. Cada canto foi pensado
              para proporcionar a melhor experiência no futevôlei.
            </p>
          </div>
        ...
        <div className="text-center bg-gradient-to-r from-emerald-900 to-amber-800 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Se você busca mais do que só um espaço para jogar, se você quer
            fazer parte de uma família apaixonada pelo futevôlei, seja bem-vindo
            à Koa House.
          </p>
